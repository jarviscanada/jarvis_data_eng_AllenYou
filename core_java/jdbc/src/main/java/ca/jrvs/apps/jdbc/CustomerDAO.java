...
public class CustomerDAO extends DataAccessObject<Customer> {
  ...
  public Customer findById(long id) {
    ...
    {
      CustomerDAO.logger.error("Error: findById failed", e);
  ...
  public Customer update(Customer dto) {
    ...
    {
      CustomerDAO.logger.error("Error: Could not disable autocommit",e);
      throw new RuntimeException(e);
    }
    ...
    }catch(SQLException e)
    {
      ...
      {
        CustomerDAO.logger.error("Error: Could not update Customer", sqle);
  ...
  public Customer create(Customer dto) {
    ...
    {
      CustomerDAO.logger.error("Error: Could not create new Customer data", e);
      throw new RuntimeException(e);
    }
  }
  ...
  public void delete(long id) {
    ...
    {
      CustomerDAO.logger.error("Error: Could not delete data", e);
      throw new RuntimeException(e);
    }
  }
}