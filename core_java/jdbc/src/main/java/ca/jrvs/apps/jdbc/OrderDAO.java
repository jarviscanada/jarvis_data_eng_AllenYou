...
public class OrderDAO extends DataAccessObject<Order> {
  public final static String GET_BY_ID= "SELECT c.first_name, c.last_name, c.email, o.order_id, o.creation_date, " +
  ...
  public static final String GET_FOR_CUST = "SELECT * FROM  get_order_by_customer(?)";
  ...
  public Order findById(long id) {
    ...
    try(PreparedStatement statement = this.connection.prepareStatement(GET_BY_ID);)
    {
      ...
      OrderDAO.logger.error("Error: findById failed",e);
  ...
  public List<Order> getOrdersForCustomer(long customerId){
    ...
    {
      OrderDAO.logger.error("Error: failed to get order for customer",e);
      throw new RuntimeException(e);
    }
    return orders;
  }
